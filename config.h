...
static const char *fonts[]          = { "Freemono:size=10" };
static const char dmenufont[]       = "Freemono:size=10";
...
static const char* scrsht[] = { "imlib2_grab", "/home/axel/s.png", NULL};
